...
export const GET_ALL_NOTIFICATION_ADMIN_SUCCESS = "GET_ALL_NOTIFICATION_ADMIN_SUCCESS";
export const GET_ALL_NOTIFICATION_ADMIN_FAIL = "GET_ALL_NOTIFICATION_ADMIN_FAIL";
export const GET_ALL_NOTIFICATION_ADMIN_ACCOUNT_SUCCESS = "GET_ALL_NOTIFICATION_ADMIN_ACCOUNT_SUCCESS";
export const GET_ALL_NOTIFICATION_ADMIN_ACCOUNT_FAIL = "GET_ALL_NOTIFICATION_ADMIN_ACCOUNT_FAIL";
