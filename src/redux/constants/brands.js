...
export const GET_ALL_BRAND_ADMIN_ACCOUNT_SUCCESS = "GET_ALL_BRAND_ADMIN_ACCOUNT_SUCCESS";
export const GET_ALL_BRAND_ADMIN_ACCOUNT_FAIL = "GET_ALL_BRAND_ADMIN_ACCOUNT_FAIL";
