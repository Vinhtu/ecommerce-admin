...
import NewAccountRemember from '../crm/NewAccountRemember';
...
const AccountRememberPage = () => {
	...
	useEffect(() => {
		...
		// dispatch(GetAdminAccountNotifications());
	}, [dispatch]);
	...
	return (
		<PageWrapper title={demoPages.crm.subMenu.customersList.text}>
																...
																<DropdownMenu isAlignmentEnd>
																	<DropdownItem>
																		<Button
																			icon='Visibility'
																			tag='a'
																			to={`../${demoPages.crm.subMenu.ViewAccountCustomor.path}/${item._id}`}>
																			View
																		</Button>
																	</DropdownItem>
																</DropdownMenu>
			...
			<NewAccountRemember setIsOpen={setEditModalStatus} isOpen={editModalStatus} />
		</PageWrapper>
	);
};

export default AccountRememberPage;
