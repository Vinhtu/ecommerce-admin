...
const LANDING = {
	DASHBOARDTEAM: lazy(() => import('../pages/dashboard/DashboardTeamPage')),

	// DASHBOARD_BOOKING: lazy(() => import('../pages/dashboard/DashboardBookingPage')),
	// SUMMARY: lazy(() => import('../pages/SummaryPage')),
	// TEAMCHAT: lazy(() => import('../pages/presentation/TeleChat/TeamChat')),
	// SUPPORTCHAT: lazy(() => import('../pages/presentation/TeleChat/SupportChat')),
};
// const SINGLE = {
...
// };
const LIST = {
	ACCOUNTCUSTOMER: lazy(() => import('../pages/presentation/demo-pages/AccountCustomorPage')),
	ACCOUNTREMEMBER: lazy(() => import('../pages/presentation/demo-pages/AccountRememberPage')),
	TEAMPOSITION: lazy(() => import('../pages/presentation/demo-pages/TeamPositionPage')),

	PRODUCTSHOP: lazy(() => import('../pages/presentation/demo-pages/ProductShopPage')),
	PRODUCTAFFILATE: lazy(() => import('../pages/presentation/demo-pages/ProductAffilatePage')),
	ORDERSHOP: lazy(() => import('../pages/presentation/demo-pages/OrderPage')),
	ORDERAFFILATE: lazy(() => import('../pages/presentation/demo-pages/OrderAffilatePage')),
	...
	AFFILATESHOP: lazy(() => import('../pages/presentation/demo-pages/AffilateShopPage')),
	COMMENT: lazy(() => import('../pages/presentation/demo-pages/CommentPage')),
	MAIL: lazy(() => import('../pages/presentation/demo-pages/MailPage')),
	VOUCHER: lazy(() => import('../pages/presentation/demo-pages/VoucherPage')),
	NOTIFICATION: lazy(() => import('../pages/presentation/demo-pages/NotificationPage')),

	AUTHLOGIN: lazy(() => import('../pages/presentation/demo-pages/AuthLoginPage')),
	AUTHLOGOUT: lazy(() => import('../pages/presentation/demo-pages/AuthLogoutPage')),
...
// 	// },
	SALES: {
		...
		AFFILATESHOPNEW: lazy(() => import('../pages/presentation/sales/AffilateshopNewPage')),
		AFFILATESHOPVIEW: lazy(() => import('../pages/presentation/sales/AffilateshopViewPage')),
		NEWPRODUCT: lazy(() => import('../pages/presentation/sales/NewProduct')),
		VIEWPRODUCT: lazy(() => import('../pages/presentation/sales/ViewProduct')),
		EDITPRODUCT: lazy(() => import('../pages/presentation/sales/EditProduct')),

		NEWVOUCHER: lazy(() => import('../pages/presentation/sales/NewVoucher')),
		VIEWVOUCHER: lazy(() => import('../pages/presentation/sales/ViewVoucher')),
		EDITVOUCHER: lazy(() => import('../pages/presentation/sales/EditVoucher')),

		NEWEVENT: lazy(() => import('../pages/presentation/sales/NewEvent')),
		VIEWEVENT: lazy(() => import('../pages/presentation/sales/ViewEvent')),
		EDITEVENT: lazy(() => import('../pages/presentation/sales/EditEvent')),
...
const presentation = [
	...
	// {
	// 	path: dashboardMenu.telechat.subMenu.teamchat.path,
	// 	element: <LANDING.TEAMCHAT />,
	// 	exact: true,
	// },
	// {
	// 	path: dashboardMenu.telechat.subMenu.supportchat.path,
	// 	element: <LANDING.SUPPORTCHAT />,
	// 	exact: true,
	// },
	 ...
	 */
	//  {
	// 	path: demoPages.Category.subMenu.category.path,
	// 	element: <LIST.CATEGORY />,
	// 	exact: true,
	// },
	{
		path: demoPages.Banner.path,
		element: <LIST.BANNER />,
		exact: true,
	},
	{
		path: demoPages.Event.path,
		element: <LIST.EVENT />,
		exact: true,
	},
	 {
	...
	{
		path: demoPages.Accounts.subMenu.remember.path,
		element: <LIST.ACCOUNTREMEMBER />,
		exact: true,
	},
	{
		path: demoPages.Accounts.subMenu.TeamPosition.path,
		element: <LIST.TEAMPOSITION />,
		exact: true,
	},

	{
		path: demoPages.Products.subMenu.product_shop.path,
		element: <LIST.PRODUCTSHOP />,
		exact: true,
	},
	{
		path: demoPages.Products.subMenu.product_affilate.path,
		element: <LIST.PRODUCTAFFILATE />,
		exact: true,
	},
	{
		path: demoPages.Products.subMenu.extend_product.path,
		element: <LIST.EXTENDPRODUCTPAGE />,
		exact: true,
	},
	{
	...
	{
		path: demoPages.Orders.subMenu.order_affilate.path,
...

	{
		...
		element: <LIST.AFFILATESHOP />,
		exact: true,
	},

	{
		path: demoPages.Comment.path,
		element: <LIST.COMMENT />,
		exact: true,
	},

	{
		path: demoPages.Mail.path,
		element: <LIST.MAIL />,
		exact: true,
	},

	{
		path: demoPages.Voucher.path,
		element: <LIST.VOUCHER />,
		exact: true,
	},

	{
		path: demoPages.Notification.path,
		element: <LIST.NOTIFICATION />,
		exact: true,
	},
	...
	{
		path: demoPages.sales.subMenu.newproduct.path,
		element: <APP.SALES.NEWPRODUCT />,
		exact: true,
	},
	{
		path: `${demoPages.sales.subMenu.editproduct.path}/:id`,
		element: <APP.SALES.EDITPRODUCT />,
		exact: true,
	},
	{
		path: `${demoPages.sales.subMenu.viewproduct.path}/:id`,
		element: <APP.SALES.VIEWPRODUCT />,
		exact: true,
	},

	{
		path: demoPages.sales.subMenu.new_order.path,
		element: <APP.SALES.NEWORDER />,
		exact: true,
	},
	{
		path: `${demoPages.sales.subMenu.view_order.path}/:id`,
		element: <APP.SALES.VIEWORDER />,
		exact: true,
	},
	{
		path: `${demoPages.sales.subMenu.edit_order.path}/:id`,
		element: <APP.SALES.EDITORDER />,
		exact: true,
	},
	...
	{
		path: `${demoPages.sales.subMenu.editvoucher.path}/:id`,
		element: <APP.SALES.EDITVOUCHER />,
		exact: true,
	},
	{
		path: `${demoPages.sales.subMenu.viewvoucher.path}/:id`,
		element: <APP.SALES.VIEWVOUCHER />,
		exact: true,
	},
	...
	{
		path: `${demoPages.sales.subMenu.editevent.path}/:id`,
		element: <APP.SALES.EDITEVENT />,
		exact: true,
	},
	{
		path: `${demoPages.sales.subMenu.viewevent.path}/:id`,
	...
	{
		path: `${demoPages.sales.subMenu.newaffilateshop.path}`,
		element: <APP.SALES.AFFILATESHOPNEW />,
		exact: true,
	},
	{
		path: `${demoPages.sales.subMenu.viewaffilateshop.path}/:id`,
		element: <APP.SALES.AFFILATESHOPVIEW />,
		exact: true,
	},
	...
	{
		path: `${demoPages.crm.subMenu.ViewAccountCustomor.path}/:id`,
		element: <APP.CRM.VIEWACCOUNTCUSTOMOR />,
		exact: true,
	},
	{
		path: `${demoPages.crm.subMenu.ViewAccountRemember.path}/:id`,
		element: <APP.CRM.VIEWACCOUNTREMEMBER />,
		exact: true,
	},
	{
		path: `${demoPages.crm.subMenu.NewAccountCustomor.path}`,
		element: <APP.CRM.NEWACCOUNTCUSTOMOR />,
		exact: true,
	},
	{
		path: `${demoPages.crm.subMenu.NewAccountRemember.path}`,
		element: <APP.CRM.NEWACCOUNTREMEMBER />,
		exact: true,
	},
